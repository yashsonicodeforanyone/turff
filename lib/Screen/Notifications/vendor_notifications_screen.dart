...
import '../../MyNetwork/notificationApi.dart';

class VendorNotificationsScreen extends StatefulWidget {
  final String turf_id;
  final String usertype;

  const VendorNotificationsScreen({Key? key, required this.turf_id, required this.usertype, }) : super(key: key);
        ...
        children: [
          Expanded(
            child: FutureBuilder<NotificationList?>(
              future: fetchNotifications(widget.turf_id, widget.usertype),
