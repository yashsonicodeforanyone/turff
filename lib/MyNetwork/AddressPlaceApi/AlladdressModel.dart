...
class AllAddress {
  ...
  factory AllAddress.fromJson(Map<String, dynamic> json) => AllAddress(
    predictions: List<Predictionn>.from(json["predictions"].map((x) => Predictionn.fromJson(x))),
    status: json["status"],
  );
...
class Predictionn {
  ...
  factory Predictionn.fromJson(Map<String, dynamic> json) => Predictionn(
